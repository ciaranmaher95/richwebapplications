...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2017 at 06:26 PM
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`user-id`) REFERENCES `userdetails` (`user-id`) ON DELETE CASCADE ON UPDATE CASCADE;
